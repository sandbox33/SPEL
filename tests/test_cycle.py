...
# ══════════════════════════════════════════════════════════════════════════
#  gold_score de punta a punta — el criterio de cierre de Fase 1
#
#  BLUEPRINT.md pide "core/scoring.py calcula un Gold Score real a partir
#  de eso, con un test que corre en CI y pasa". Este es ese test, y
#  verifica EL VALOR, no que no lance excepción: un test que solo
