...
Uso en Colab:
  !cp /content/drive/MyDrive/ORDEN/SPEL 3.0/meta/spel_auditoria_total.py /content/
  !python /content/spel_auditoria_total.py

Output:
  /content/drive/MyDrive/ORDEN/SPEL 3.0/meta/auditoria_total_YYYYMMDD_HHMM.json
  /content/drive/MyDrive/ORDEN/SPEL 3.0/meta/SHA_REGISTRY.json  ← fuente de verdad SHA
═══════════════════════════════════════════════════════════════════════════════
"""
