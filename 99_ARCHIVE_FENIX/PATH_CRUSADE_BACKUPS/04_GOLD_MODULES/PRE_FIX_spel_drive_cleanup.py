...
TO_DELETE = [
    {
        ...
        'reason': 'DEPRECADA desde S20. Todo lo útil fue migrado a SPEL-v2.0.',
    },
    {
                ...
                for root_dir, dirs, files in os.walk(path):
                    for f in files:
                        if asset in f and 'ohlcv_v5' in f:
                            ...
                            fail("ABORT — verificar que SPEL-v2.0 tiene este parquet antes de borrar")
                            return False
...
def cleanup(dry_run: bool = True):
    ...
    # Verificar SPEL-v2.0 después de la limpieza
    if not dry_run:
