...
DRIVE_ROOT   = Path("/content/drive/MyDrive/ORDEN/SPEL 3.0")
...
import shutil
workflow_src = Path("/content/drive/MyDrive/ORDEN/SPEL 3.0/meta/spel_github_sync.yml")
...
`/content/drive/MyDrive/ORDEN/SPEL 3.0/data_lake/`
